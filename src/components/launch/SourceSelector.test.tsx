	...
	useScopedT: (namespace: string) => {
		...
		return (key: string, vars?: Record<string, string>) => {
			...
			if (key === "sourceSelector.emptyDescription") {
				return "If you just granted screen recording permission, reload this picker. On macOS you may need to reopen Íris.";
			}
			if (key === "sourceSelector.loadFailedDescription") {
				return "Íris could not load capture sources. Reload this picker and try again.";
			}

		...
		<div className="p-1 flex flex-col gap-4 items-center">
			<div className="flex items-center gap-2 w-full">
				<Button
					...
					style={{
						backgroundColor: colorMode === "wheel" ? "#5E5CE6" : "transparent",
					}}
				>
				...
				<Button
					...
					style={{
						backgroundColor: colorMode === "palette" ? "#5E5CE6" : "transparent",
					}}
				>
					<span className="text-xs text-slate-300 truncate flex-1 text-left">
			...
			{colorMode === "wheel" && (
				<>
					...
					<Input
						type="text"
						value={hexInput}
						className="w-full h-9 rounded-md border border-white/10 bg-white/5 px-2 text-xs text-slate-200 outline-none focus:border-[#5E5CE6]/50 focus:ring-1 focus:ring-[#5E5CE6]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"

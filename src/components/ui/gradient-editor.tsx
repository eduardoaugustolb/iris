		...
		<div className="w-[240px] max-w-full mx-auto rounded-[18px] p-[10px] box-border font-sans text-[#f2f2f2] select-none">
			...
			>
				...
				>
					...
					<div
						...
						className="absolute w-11 h-11 rounded-full cursor-grab shadow-[0_0_0_4px_#f5f5f5,0_4px_14px_rgba(0,0,0,0.35)] transition-shadow z-10 active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-[#5E5CE6]"
						style={{
							left: `${mainX}%`,
							top: `${mainY}%`,
							transform: "translate(-50%, -50%)",
			...
			<div className="flex items-center gap-3.5 mt-3.5">
				...
				<div
					...
					className="relative flex-1 h-10 flex items-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#5E5CE6] rounded"
				>
					<svg
						width="100%"
						height="30"
				...
				<div
					...
					aria-valuemax={360}
					aria-valuenow={angle}
					className="relative w-[42px] h-[42px] rounded-full bg-[radial-gradient(circle_at_35%_30%,#2b2b2b,#0c0c0c)] shadow-[0_3px_10px_rgba(0,0,0,0.4)] cursor-grab flex-shrink-0 active:cursor-grabbing focus:outline-none focus:ring-2 focus:ring-[#5E5CE6]"
